Shoot = function (startX, startY, destinationX, destinationY) {
    ...
    const nSpeed = canvas.height*canvas.width*0.00013
    const nY = nSpeed*(y/distance) - (canvas.width/canvas.height)*nSpeed/20
    ...
    var distans = Math.abs(startX+destinationX - this.shoot.x)//TODO refactor this
